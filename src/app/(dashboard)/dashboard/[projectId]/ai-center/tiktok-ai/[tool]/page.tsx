...
import { getTikTokTool } from "@/lib/ai-center/tools/tiktok";
...
export async function generateMetadata({
  ...
  const tool = getTikTokTool(toolSegment);
  return { title: tool ? tool.label : "TikTok AI" };
}

export default async function TikTokToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

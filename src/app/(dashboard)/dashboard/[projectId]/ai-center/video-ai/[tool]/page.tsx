...
import { getVideoAiTool } from "@/lib/ai-center/tools/video-ai";
...
export async function generateMetadata({
  ...
  const tool = getVideoAiTool(toolSegment);
  return { title: tool ? tool.label : "Video AI" };
}

export default async function VideoAiToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

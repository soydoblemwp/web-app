...
import { getFacebookTool } from "@/lib/ai-center/tools/facebook";
...
export async function generateMetadata({
  ...
  const tool = getFacebookTool(toolSegment);
  return { title: tool ? tool.label : "Facebook AI" };
}

export default async function FacebookToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

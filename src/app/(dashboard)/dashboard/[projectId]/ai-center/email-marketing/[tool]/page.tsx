...
import { getEmailMarketingTool } from "@/lib/ai-center/tools/email-marketing";
...
export async function generateMetadata({
  ...
  const tool = getEmailMarketingTool(toolSegment);
  return { title: tool ? tool.label : "Email Marketing AI" };
}

export default async function EmailMarketingToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

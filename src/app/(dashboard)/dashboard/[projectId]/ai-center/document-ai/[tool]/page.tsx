...
import { getDocumentAiTool } from "@/lib/ai-center/tools/document-ai";
...
export async function generateMetadata({
  ...
  const tool = getDocumentAiTool(toolSegment);
  return { title: tool ? tool.label : "Document AI" };
}

export default async function DocumentAiToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

...
import { getImageAiTool } from "@/lib/ai-center/tools/image-ai";
...
export async function generateMetadata({
  ...
  const tool = getImageAiTool(toolSegment);
  return { title: tool ? tool.label : "Image AI" };
}

export default async function ImageAiToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

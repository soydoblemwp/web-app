...
import { getLinkedInTool } from "@/lib/ai-center/tools/linkedin";
...
export async function generateMetadata({
  ...
  const tool = getLinkedInTool(toolSegment);
  return { title: tool ? tool.label : "LinkedIn AI" };
}

export default async function LinkedInToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {

...
import { getBlogSeoTool } from "@/lib/ai-center/tools/blog-seo";
...
export async function generateMetadata({
  ...
  const tool = getBlogSeoTool(toolSegment);
  return { title: tool ? tool.label : "Blog & SEO AI" };
}

export default async function BlogSeoToolPage({
  params,
}: {
  params: Promise<{ projectId: string; tool: string }>;
}) {
